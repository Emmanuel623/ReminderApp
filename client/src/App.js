        ...
        <>
            <div className="flex-show">
                <div className="header">
                    <nav>
                        <ul>
                            <li><img src="https://e0.pxfuel.com/wallpapers/181/282/desktop-wallpaper-medical-and-background-doctor-medicine.jpg" /></li>
                            <li onClick={() => addclick()}>GET Appointment</li>
                            <li onClick={() => bookingclick()}>ALL BOOKINGS</li>
                            <li onClick={() => doctorclick()}>DOCTORS LIST</li>
                            <li onClick={() => customerclick()}>CUSTOMERS LIST</li>
                            <li onClick={() => Reminderclick()}>REMINDERS</li>
                        </ul>
                    </nav>
                </div>
